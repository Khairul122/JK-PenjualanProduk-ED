...
function previewPDF() {
    ...
    img.onload = function() {
        ...
        // Teks "Laporan Produksi" di tengah halaman
        doc.setFontSize(16);
        doc.text("Laporan Produksi", pageWidth / 2, marginTop + imgHeight / 2 + 5, { align: "center" });

        // Garis bawah teks "Laporan Produksi"
        ...
        doc.autoTable({
            head: [['No', 'Nama Produk', 'Tanggal', 'Total Produksi']],
            body: rows,
            startY: startY,
            theme: 'grid',
            headStyles: {
