...
function previewPDF() {
    ...
    img.onload = function() {
        ...
        // Teks "Laporan Pembatalan Pesanan" di tengah halaman
        doc.setFontSize(16);
        doc.text("Laporan Pembatalan Pesanan", pageWidth / 2, marginTop + imgHeight / 2 + 5, { align: "center" });

        // Garis bawah teks "Laporan Pembatalan Pesanan"
        ...
        doc.autoTable({
            head: [['No', 'Nama Produk', 'Tanggal', 'Qty']],
            body: rows,
            startY: startY,
            theme: 'grid',
            headStyles: {
