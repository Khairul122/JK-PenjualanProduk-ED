	...
	<footer style="border-top: 4px solid #ff8680;  ">
		<div class="container" style="padding-bottom: 50px;">
			<div class="row">
				<div class="col-md-4">
					<h3 style="color: #ff8680"><b>Serambi Milk Padang Panjang</b></h3>
					<p>Jln syekh Ibrahim Musa RT 07 kelurahan Ganting kecamatan Padang panjang</p>
					<p><i class="glyphicon glyphicon-earphone"></i> +6287804616097</p>
					<p><i class="glyphicon glyphicon-envelope"></i> serambimilk@gmail.com</p>
				</div>
				<div class="col-md-4">
					<h5><b>Menu</b></h5>
